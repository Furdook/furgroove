...
function Events({ children }: React.PropsWithChildren) {
	return (
		<section className="flex flex-col gap-2 md:gap-12 md:p-4">
...
function Event(event: EventProps) {
	return (
		<div className="relative flex gap-10 md:pl-8">
			...
			<div className="max-md:bg-primary-700/25 border-t-primary-100/10 border-l-primary-100/10 ring-primary-700/20 relative flex flex-col gap-4 p-2 pl-8 max-md:rounded-xl max-md:border-t max-md:border-l max-md:p-4 max-md:shadow-md max-md:ring">
				<div
					style={{ backgroundColor: event.color }}
