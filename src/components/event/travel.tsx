			...
			<div className="grid grid-cols-1 gap-2 md:gap-4 md:grid-cols-3">
				...
				<Card className="col-span-2 flex flex-col max-md:order-1 max-md:gap-4">
					...
					<Card.Content className="my-auto flex flex-col gap-6">
						<p>
							...
							chill and chat, it’s everything you love about FurGroove — turned
							up a notch.
						</p>
						<p>
				...
				<Card className="col-span-2 flex flex-col max-md:order-3 max-md:gap-4">
					...
					<Card.Content className="my-auto flex flex-col gap-6">
						...
						<p>
							From Amerfoort Centraal you can take bus no. 17 to Plesmanstraat,
							from here the event location is a short ~7min walk away. If you
							are staying at the VanderValk hotel it is a ~10min walk to
							FurGroove.
						</p>
					</Card.Content>
				</Card>
