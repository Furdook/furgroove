...
export default function Information() {
	return (
		<section className="flex flex-col gap-2 p-2 md:p-4 ">
			...
			<p>
				We wish to create the best atmosphere possible for everyone attending
				FurGroove, we therefore encourage you to read our&nbsp;
				<NavLink
				...
				&nbsp;before attending the party. Here you may also find general
				rulesets for the event, in addition to our dress code. If you have any
				further questions not listed, you can contact us though our&nbsp;
				<a
