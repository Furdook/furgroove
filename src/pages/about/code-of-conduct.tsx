	...
	return (
		<>
			...
			<main className="flex flex-col gap-2.5 p-2 pb-12 md:p-4">
				<h2 className="text-accent-pink text-2xl uppercase ">
					Code of Conduct
				</h2>
				<p className="pt-4">
				...
				<ul className="list-paw relative py-4 pl-10">
					<li>
						It is not allowed to climb over any railings or walk on parts that
						are off limits for attendees.
					</li>
					<li>
				...
				<ul className="list-paw relative py-4 pl-10">
					...
					<li>
						Display of fetish gear is not permitted in public, even if it is
						part of a costume.
					</li>
				</ul>
				<h3 className="pt-2 pb-4 text-xl">Drugs & Alcohol</h3>
				<p>
					It is forbidden to bring or use drugs to the party. If we find you in
					the possession of or distributing illegal or controlled substances we
					will notify the local authorities and the venue. Smoking and vaping is
					only allowed in the designated smoking areas.
				</p>
