...
export default function Artist(props: {
  ...
  return (
    <Card
      id={props.className}
      className={`${props.className ? "team-member" : ""} flex max-w-[712px] flex-col gap-6 px-6 text-primary-900 md:mx-auto md:max-w-full md:flex-row md:even:flex-row-reverse`}
    >
